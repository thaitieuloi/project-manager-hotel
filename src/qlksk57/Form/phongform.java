...
public class phongform extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		String tinhTrang[] = {"Trống", "Đã Thuê"};
		comboBoxTINHTRANG = new JComboBox(tinhTrang);
					...
					.addGroup(jPanel18Layout.createParallelGroup(Alignment.LEADING)
						.addGroup(jPanel18Layout.createSequentialGroup()
							...
							.addGroup(jPanel18Layout.createParallelGroup(Alignment.TRAILING, false)
								.addComponent(sua3, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(thoat3, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
							.addGap(18)
						...
						.addGroup(jPanel18Layout.createSequentialGroup()
							...
							.addGroup(jPanel18Layout.createParallelGroup(Alignment.LEADING, false)
								.addComponent(comboBoxTINHTRANG, 0, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
		...
		jPanel18Layout.setVerticalGroup(
			jPanel18Layout.createParallelGroup(Alignment.LEADING)
				.addGroup(jPanel18Layout.createSequentialGroup()
					...
					.addGroup(jPanel18Layout.createParallelGroup(Alignment.LEADING)
						.addGroup(jPanel18Layout.createSequentialGroup()
							.addComponent(jTextFieldMAPHONG, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(jTextFieldTENPHONG, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(comboBoxLOAIPHONG, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(jTextFieldGIAPHONG, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(jTextFieldCHUTHICHP, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
							.addGap(1)
							.addComponent(comboBoxTINHTRANG, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addComponent(comboBoxMANVP, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(comboBoxMADVP, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addGroup(jPanel18Layout.createSequentialGroup()
							.addComponent(jLabel23)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(jLabel24)
		...
		jPanel18Layout.linkSize(SwingConstants.VERTICAL, new Component[] {jLabel23, jLabel24, jLabel25, jLabel26, jLabel27, jLabel28, jTextFieldMAPHONG, jTextFieldTENPHONG, jTextFieldGIAPHONG, jTextFieldCHUTHICHP, jLabel29, jLabel30, comboBoxLOAIPHONG, comboBoxMANVP, comboBoxMADVP});
...
//		String tinhTrang = model.getValueAt(i, 5) == null ? "" : model.getValueAt(i, 5).toString() ;
		comboBoxTINHTRANG.setSelectedIndex(model.getValueAt(i, 5).toString().equals("Trống") ? 0 : 1);
	...
	private void them3ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_them3ActionPerformed
		...
		try {
			...
			String query = "INSERT INTO phong(MAPHONG,TENPHONG, LOAIPHONG, GIAPHONG, CHUTHICH, TINHTRANG, MANV, MADV) VALUES('"
					...
					+ jTextFieldCHUTHICHP.getText() + "', '" + comboBoxTINHTRANG.getSelectedItem() + "', '"
					+ maNV + "', '" + maDV + "')";
	...
	private void sua3ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_sua3ActionPerformed
		if (jTablePHONG.getSelectedRow() == -1) {
			...
			model.setValueAt(comboBoxTINHTRANG.getSelectedItem(), jTablePHONG.getSelectedRow(), 5);
			...
			try {
				...
				String query = String.format(
						...
						jTextFieldCHUTHICHP.getText(), comboBoxTINHTRANG.getSelectedItem(), maNV,
