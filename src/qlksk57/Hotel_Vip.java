...
public class Hotel_Vip extends javax.swing.JFrame {
    ...
    public void hienThiDanhSachNhanVien() {
        String colTieuDe1[] = new String[]{"Mã nhân vien", "Tên nhân viên", "Chức vụ", "Lương", "Ngày Sinh", "Giới tính", "Chú thích"};
    ...
    public void hienThiDanhSachPhong() {
        String colTieuDe1[] = new String[]{"Mã Phòng", "Tên Phòng", "Loại Phòng", "Gía Phòng", "Chú Thích", "Tình Trạng", "Mã Nhân Viên", "Mã Dịch Vụ"};
